...
//   half of the SRAM usage by eliminating off-screen drawing, or if we were to eliminate fading, or if
...
byte a5_FontTable[] = {
    ...
    64,0,3,    // ! (Yes, lame, but it's the "standard." Better Suggestions welcome.)
    0,0,40,  // "
    63,3,255,    //#
    63,1,42,    //$
    57,3,106,    //%
